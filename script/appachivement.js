...
const string = [
  "Efekt: Karta kolekcjonera",
  "Scenki Alkoholowe",
  "Wiele, wiele kolorowych ciast",
  "Ale się pali!",
  "Cóż za wspaniały likier.",
  "Znakowniki",
  "Chyba chodzę w kółko",
  "Przyszłość przyniesie...",
  "Dziecko wewnątrz mnie",
  "Pokaz mi odcisk ryby a przepowiem Ci przyszłość",
  "Pitagoras byłby dumny",
  ""
];
